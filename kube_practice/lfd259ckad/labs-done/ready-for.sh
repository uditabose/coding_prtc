...
#
# Version 6.33: 2018-01-19
#     - Clean up md5sum fetching
#     - Fix up JSON generation
#     - Remove kit from LFD415
#===============================================================================
VERSION=6.34
...
#   DISTROS[LFXXXX]="Fedora-25+ CentOS-6+ Ubuntu-16.04+"
...
FALLBACK=(
    ...
    [Fedora]="RHEL CentOS"
    [Fedora-25]="Fedora"
    [Fedora-26]="Fedora-25 Fedora"
    [Fedora-27]="Fedora-26 Fedora"
    [Fedora-999]="Fedora-27 Fedora-26"
    [LinuxMint]="Ubuntu"
...
DISTROS[LFD]="CentOS-7+ Debian-8+ Fedora-25+ LinuxMint-18+ openSUSE-42.1+ RHEL-7+ Ubuntu-16.04+LTS+ SLES-12+"
DISTROS[LFS]="CentOS-7+ Debian-8+ Fedora-25+ LinuxMint-17+ openSUSE-42.1+ RHEL-7+ Ubuntu-14.04+LTS+ SLES-12+"
...
#===============================================================================
PACKAGES[@kernel]="asciidoc crash cscope gitk sysfsutils indent xmlto"
#-------------------------------------------------------------------------------
PACKAGES[Debian_@kernel]="exuberant-ctags libelf-dev libfuse-dev libssl-dev
...
PACKAGES[RHEL_@kernel]="ctags elfutils-libelf-devel fuse-devel kernel-devel
	libhugetlbfs-devel ncurses-devel nfs-utils"
...
PACKAGES[Debian-999_@virt]="-virt-manager"
...
PACKAGES[openSUSE-999_LFD401]="-ElectricFence"
...
PACKAGES[Fedora-25_LFD460]="-python-ply"
PACKAGES[Fedora-26_LFD460]="-python -python-ply"
PACKAGES[Fedora-27_LFD460]="[Fedora-26_LFD460] -python-progressbar"
...
PACKAGES[openSUSE-999_LFD460]="-python-ply -python-progressbar"
...
WEBPAGE[LFS132]="$LFSTRAINING/introduction-to-cloud-foundry-and-cloud-native-software"
INPERSON[LFS132]=n
VIRTUAL[LFS132]=n
SELFPACED[LFS132]=y
...
WEBPAGE[LFS171]="$LFSTRAINING/blockchain-for-business-an-introduction-to-hyperledger"
INPERSON[LFS171]=n
VIRTUAL[LFS171]=n
SELFPACED[LFS171]=y
...
VIRTUAL[LFS201]=n
SELFPACED[LFS201]=y
PACKAGES[LFS201]="@build @common @docker @sysadm @trace @virt cryptsetup lvm2 quota xfsprogs"
...
PACKAGES[Debian-8_LFS265]="-mininet -openvswitch-testcontroller"
PACKAGES[Debian-999_LFS265]="[Ubuntu_LFS265] -openvswitch-test"
...
WEBPAGE[LFS305]="$LFSTRAINING/deploying-and-managing-linux-on-azure-0"
#-------------------------------------------------------------------------------
OS[LFS305]="$ANYOS"
OS_NEEDS[LFS305]="$REMOTE_NEEDS"
#-------------------------------------------------------------------------------
...
# shellcheck disable=SC2034
OS[LFS458]="$UNIXOS"
OS_NEEDS[LFS458]="$REMOTE_NEEDS, VirtualBox, Kubernetes CLI (kubectl)"
